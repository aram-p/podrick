...
Public repo. What is actually live:
...
attaches stripped binaries to the release. A second job regenerates the Homebrew formula
from those published assets — reading the checksums off what was uploaded, never off a
